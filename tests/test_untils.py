...
from src.utils import read_transaction_data, calculate_total_amount
...
def test_read_transaction_data_success(mock_open: MagicMock) -> None:
    ...
    result = read_transaction_data(Path("test_transactions.json"))
    assert result == []
...
def test_read_transaction_data_empty_file() -> None:
    # Создаем пустой файл
