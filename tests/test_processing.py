...
@pytest.mark.parametrize(
    "state_status, expected_output",
    [
        ("EXECUTED", [{"state": "EXECUTED", "date": "2022-01-15"}, {"state": "EXECUTED", "date": "2022-02-01"}]),
        ("FAILED", [{"state": "FAILED", "date": "2022-03-05"}]),
    ],
)
def test_filter_by_state(
    sample_data: List[Dict[str, Any]], state_status: str, expected_output: List[Dict[str, Any]]
) -> None:
