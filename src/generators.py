...
def filter_currency(transactions: List[dict], currency: str) -> Generator[Any, None, None]:
    """
...
usd_transactions = filter_currency(transactions, "USD")
...
def number_generator(start: int, end: int) -> Generator[str, Any, None]:
    """
